...
{Snowflake}{San Mateo CA}{}
{
    ...
    \begin{itemize}
        \item Maintained and improved the quality of Snowflake's SQL compiler, which executes over 6 billion queries a day. Participated in a support rotation that involved triaging and resolving customer issues.
        \item Overhauled dozens of compiler optimization passes using a new internal compiler framework as part of a multi-quarter effort to improve compilation time and reduce the rate of hard-to-diagnose errors.
        \item Diagnosed query planning issues that resulted in poor performance in Snowflake's parallel execution architecture, such as cardinality misestimation or late filtering.
