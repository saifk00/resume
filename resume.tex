...
{Snowflake}{San Mateo CA}{}
{
    ...
    \begin{itemize}
        \item Led design of new SQL syntax enabling multiple policies on a table, reducing boilerplate and preventing errors in applying privacy constraints. % Implemented compiler changes in \textbf{Java} and \textbf{FoundationDB} metadata updates to support this functionality.
